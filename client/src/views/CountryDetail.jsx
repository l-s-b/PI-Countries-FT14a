...
function CountryDetail() {
  ...
  const waitgif =
    "https://i.pinimg.com/originals/2b/07/f6/2b07f62987e987d4e53e84aa8b963b83.gif";
  useEffect(() => {
      ...
      return (
        <div className="country">
          ...
          <p>
            Density:{" "}
            {Math.round(
              (Number(c.population) / Number(c.area) + Number.EPSILON) * 100
            ) /
              100 +
              " [/km²]"}
          </p>
